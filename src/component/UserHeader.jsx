        ...
        <div class="flex h-14 sm:h-14 lg:h-20 px-2  items-center justify-between">
          ...
          <div className="relative mr-4 ml-4">
            ...
            <input
              type="text"
              placeholder="Search"
              className="w-full sm:w-72 md:w-100 lg:w-120 pl-10 px-8 py-1 border border-black rounded-full bg-[#F6F6F8]" // Adjusted widths for different breakpoints
            />
          </div>
          ...
          <div className="flex gap-4 items-center">
            <div className="hidden sm:flex items-center gap-x-3">
              ...
              <div>
                <h1 className="text-sm font-semibold">Stores & Services</h1>
                <p className="text-xs text-gray-600">Choose Your Store</p>
              </div>
            </div>
            <div className="hidden sm:flex items-center gap-x-3">
              <div>
              ...
              <div>
                <h1 className="text-sm font-normal">Community</h1>
              </div>
            </div>
            <div className="hidden sm:flex items-center gap-x-3">
              <div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">for FREE Shipping</p>
              </div>
            </div>
