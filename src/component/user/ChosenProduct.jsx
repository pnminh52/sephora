...
const ChosenProduct = ({ products }) => {
  ...
  //       {/* Fixed-width grid */}
  //       <div
  //         className="grid grid-cols-6 gap-2 min-w-[1200px] transition-transform duration-500 ease-in-out"
  //       >
  ...
  //               <p className="text-sm text-black py-1  ">{product.content.slice(0,45)}...</p>
  //               <div className="">
  ...
  //         className="absolute left-10 top-1/2 px-3 py-3 bg-black text-white rounded-full opacity-80 disabled:opacity-0 -ml-6"
  //       >
  //         <svg
  ...
  //         className="absolute right-10 top-1/2  px-3 py-3 bg-black text-white rounded-full opacity-80 disabled:opacity-0 -mr-6"
  //       >
  //         <svg
  //           className="w-[30px] h-[30px]"
  //           viewBox="0 0 24 24"
